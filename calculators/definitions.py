...
CALCULATORS = [
    ...
    _definition('elektrika', 'Электрика', 'Расчёт материалов: кабель, автоматы, розетки, выключатели, гофра, клипсы, щит и защита.', 'electric', 'точка', [
        ...
        _material('Распределительные коробки', 1.0, 'шт', 650),
        _material('Автоматы', 1.0, 'шт', 3500),
        _material('УЗО / дифавтомат', 1.0, 'шт', 12000),
        _material('Щит электрический', 1.0, 'шт', 28000),
        _material('Гофра', 1.0, 'м', 250),
        _material('Клипсы / крепёж', 1.0, 'шт', 45),
        _material('TV кабель', 1.0, 'м', 220),
        _material('Интернет кабель', 1.0, 'м', 280),
        _material('Изолента', 1.0, 'шт', 700),
        _material('Стяжки пластиковые', 1.0, 'пачка', 1800),
        _material('Алебастр / гипс для подрозетников', 1.0, 'кг', 300),
