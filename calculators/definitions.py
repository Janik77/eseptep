...
PLASTER_FIELDS = [
    ...
    {'name': 'thickness', 'label': 'Толщина штукатурки (см)', 'type': 'text', 'unit': '', 'inputmode': 'decimal', 'autocomplete': 'off', 'decimal_field': True, 'min': 0.1, 'max': 20, 'default': 2},
]

DRYWALL_FIELDS = [
    {'name': 'area', 'label': 'Площадь (м²)', 'type': 'number', 'unit': '', 'min': 1, 'step': 0.1, 'default': 20},
    {'name': 'rooms', 'label': 'Количество комнат', 'type': 'number', 'unit': '', 'min': 1, 'step': 1, 'default': 1},
    {
...
SELF_LEVEL_FIELDS = [
    ...
    {'name': 'thickness', 'label': 'Толщина (см)', 'type': 'text', 'unit': '', 'inputmode': 'decimal', 'autocomplete': 'off', 'decimal_field': True, 'min': 0.1, 'max': 20, 'default': 2},
]
...
TILE_FIELDS = [
    ...
    },
    {
        ...
        'options': [
            ...
            {'value': 'large', 'label': '120×60 / крупный формат'},
        ],
    },
]
...
CALCULATORS = [
    ...
    _definition('gipsokarton-potolok', 'Гипсокартон', 'Количество комнат влияет на периметр, профиль UD/UW, крепёж и точность расчёта.', 'drywall', 'м²', [
    ...
    ], DRYWALL_FIELDS, legacy_slugs=['gipsokarton'], warning='Малярные материалы не включены. Тут считается только монтаж гипсокартона и каркас. Для точного расчёта важны планировка, количество комнат, высота, ниши, световые линии и сложность потолка.'),
    ...
    _definition('plitka-keramogranit', 'Плитка / Керамогранит', 'Плитка, керамогранит, грунтовка, клей, фуга и СВП по зоне укладки и формату.', 'tile', 'м²', [
        _material('Плитка / керамогранит', 1.0, 'м²', 12000),
        _material('Грунтовка', 1.0, 'кг', 500),
        _material('Гидроизоляция', 1.0, 'кг', 1800),
        _material('Плиточный клей', 1.0, 'меш', 4500),
        _material('Фуга', 1.0, 'кг', 1800),
        _material('СВП', 1.0, 'шт', 20),
    ], TILE_FIELDS, legacy_slugs=['plitka'], warning='⚠️ Расчёт предварительный. Для санузла порядок работ: грунтовка → гидроизоляция → плиточный клей → плитка → фуга.'),
