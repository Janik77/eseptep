...
CALCULATORS = [
    ...
    _definition('elektrika', 'Электрика', 'Расчёт материалов: кабель, автоматы, розетки, выключатели, гофра, клипсы, щит и защита.', 'electric', 'точка', [
        _material('Кабель ВВГнг-LS 3×1.5', 1.0, 'м', 580),
        _material('Кабель ВВГнг-LS 3×2.5', 1.0, 'м', 950),
        _material('Кабель ВВГнг-LS 3×6', 1.0, 'м', 2000),
        _material('Гофра 16 мм', 1.0, 'м', 250),
        _material('Гофра 20 мм', 1.0, 'м', 320),
        _material('Клипсы для гофры', 1.0, 'шт', 45),
        _material('Дюбель-гвоздь / анкер', 1.0, 'шт', 55),
        _material('Гвозди Toua / расходник', 1.0, 'шт', 65),
        _material('Розетки', 1.0, 'шт', 1800),
        _material('Выключатели', 1.0, 'шт', 1600),
        _material('Подрозетники', 1.0, 'шт', 250),
        _material('Распредкоробки', 1.0, 'шт', 650),
        _material('Автомат 10А', 1.0, 'шт', 3200),
        _material('Автомат 16А', 1.0, 'шт', 3500),
        _material('Автомат 25А', 1.0, 'шт', 4200),
        _material('Автомат 32А', 1.0, 'шт', 4500),
        _material('УЗО', 1.0, 'шт', 12000),
        _material('Дифавтомат', 1.0, 'шт', 15000),
        _material('Реле напряжения', 1.0, 'шт', 18500),
        _material('Электрощит', 1.0, 'шт', 28000),
        _material('DIN-рейка', 1.0, 'шт', 1200),
        _material('Нулевая шина', 1.0, 'шт', 950),
        _material('Заземляющая шина', 1.0, 'шт', 950),
        _material('Клеммы WAGO', 1.0, 'шт', 180),
        _material('Интернет кабель UTP', 1.0, 'м', 280),
        _material('ТВ кабель', 1.0, 'м', 220),
        _material('Кабель домофона', 1.0, 'м', 160),
        _material('Изолента', 1.0, 'шт', 700),
        _material('Стяжки пластиковые', 1.0, 'пачка', 1800),
        _material('Алебастр', 1.0, 'кг', 300),
